...
public class MealDao implements Dao<Meal> {
    ...
    static {
        meals.add(new Meal(++count, of(2020, JANUARY, 30, 10, 0), "Завтрак", 500));
        meals.add(new Meal(++count, of(2020, JANUARY, 30, 13, 0), "Обед", 1000));
        meals.add(new Meal(++count, of(2020, JANUARY, 30, 20, 0), "Ужин", 500));
        meals.add(new Meal(++count, of(2020, JANUARY, 31, 0, 0), "Еда на граничное значение", 100));
        meals.add(new Meal(++count, of(2020, JANUARY, 31, 10, 0), "Завтрак", 1000));
        meals.add(new Meal(++count, of(2020, JANUARY, 31, 13, 0), "Обед", 500));
        meals.add(new Meal(++count, of(2020, JANUARY, 31, 20, 0), "Ужин", 410));
    }
